setenv bootargs console=ttyS0,115200 panic=5 console=tty0 rootwait root=/dev/mmcblk2p2 earlyprintk rw
...
load mmc 2:1 0x41000000 zImage
load mmc 2:1 0x41800000 sun8i-s3-elimo-initium.dtb
